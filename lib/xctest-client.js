...
class XCTest extends EventEmitter {
  ...
  *startBootstrap() {
    return new Promise((resolve, reject) => {
      ...
      var args = 'test -project /Users/xdf/prjs/macaca/XCTestWD/XCTestWD/XCTestWD.xcodeproj -scheme XCTestWDUITests -destination id=336D56E4-2399-4239-A82D-FB737B2724B9 XCTESTWD_PORT=8001'.split(' ')
      var args1 = `test -project ${XCTestWD.projectPath} -scheme XCTestWD -destination id=${this.device.deviceId} XCTESTWD_PORT=${this.proxyPort}`.split(' ');
